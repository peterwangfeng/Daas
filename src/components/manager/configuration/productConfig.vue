              ...
              <el-table :data="item.params" border>
                ...
                <el-table-column align="center" label="值" prop="value">
                  <template scope="scope">
                    <el-input v-model="scope.row.value.value" :disabled="scope.row.value.isDisabled"
                              :placeholder="scope.row.value.placeholder"></el-input>
                  </template>
                </el-table-column>
        ...
        api: [
          {
            ...
            method: 'HTTP POST',
            data: '',
            note: '调用易启策API发起一个获取手机短信验证码任务',
            url: 'http://118.190.132.110:5000/user-profile/v1/waimai/tasks/',
            interface_url: '',
            isExpanded: false,
            params: [{
              param: 'app_id',
              name: '商户ID',
              value: {value: '', isDisabled: true, placeholder: ''},
              note: '分配的商户ID'
            }, {
              param: 'platform_id',
              name: '产品ID',
              ...
              param: 'user_id',
              name: '用户ID',
              value: {value: '', isDisabled: false, placeholder: '请填写用户ID'},
              note: '客户能通过此id关联到自己的用户或者业务'
            }, {
              param: 'phone',
              name: '手机号码',
              value: {value: '', isDisabled: false, placeholder: '请填写手机号码'},
              note: '用户的手机号码'
            }, {
              param: 'origin',
              name: '认证方式',
              value: {value: '', isDisabled: false, placeholder: '请填写认证方式'},
              note: '认证方式(2)'
            }, {param: 'ip', name: 'IP', value: {value: '', isDisabled: false, placeholder: '请填写IP地址'}, note: 'IP地址'}]
          },
          {
            title: '发送手机验证码',
            method: 'HTTP POST',
            data: '',
            note: '调用易启策API发起一个外卖地址采集任务',
            url: 'http://118.190.132.110:5000/user-profile/v1/waimai/{request_key}/validate_code',
            interface_url: '',
            isExpanded: false,
            params: [{
              param: 'request_key',
              name: '请求key',
              value: {value: '', isDisabled: false, placeholder: '请填写唯一的key'},
              note: '标识请求的唯一性的key'
            }, {
              param: 'validate_code',
              name: '验证码',
              value: {value: '', isDisabled: false, placeholder: '请填写验证码'},
              note: '验证码'
            }]
          },
          {
            ...
            method: 'HTTP GET',
            data: '',
            note: '任务创建成功后，根据task_id来查询任务状态',
            url: 'http://118.190.132.110:5000/user-profile/v1/waimai/tasks/{task_id}/status/',
            interface_url: '',
            isExpanded: false,
            params: [{
              param: 'task_id',
              name: '任务ID',
              value: {value: '', isDisabled: false, placeholder: '请填写任务ID'},
              note: '创建的任务的ID'
            }]
          },
          {
            ...
            method: 'HTTP GET',
            data: '',
            note: '根据task_id获取上一次任务爬取的用户数据',
            url: 'http://118.190.132.110:5000/user-profile/v1/waimai/tasks/{task_id}/orders/',
            interface_url: '',
            isExpanded: false,
            params: [{
              param: 'task_id',
